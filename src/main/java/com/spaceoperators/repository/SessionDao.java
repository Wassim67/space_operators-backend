...
public class SessionDao {
    ...
    public void resetReadyStatus(String gameId) {
        String sql = "UPDATE session SET isReady = :isReady WHERE id_game = :gameId";
        MapSqlParameterSource params = new MapSqlParameterSource()
                .addValue("isReady", false)
                .addValue("gameId", gameId);
        jdbcTemplate.update(sql, params);
    }

    public void removePlayerFromAllSessions(String playerId) {
        String sql = "DELETE FROM session WHERE id_player = :playerId";
        MapSqlParameterSource params = new MapSqlParameterSource()
    ...
    public boolean gameExists(String gameId) {
        String sql = "SELECT COUNT(*) FROM game WHERE id_game = :gameId";
        MapSqlParameterSource params = new MapSqlParameterSource()
                .addValue("gameId", gameId);
    ...
    public String getGameIdForPlayer(String playerId) {
        ...
        if (results.isEmpty()) {
            throw new RuntimeException("No session found for playerId: " + playerId);
        }
